...
<img src={`${base}/images/diagrams/architecture_flow.jpg`} alt="Resume Review Agent System Architecture" class="w-full max-w-4xl mx-auto rounded-lg" />
...
<img src={`${base}/images/diagrams/state_transition_flow.jpg`} alt="State Transition Flow" class="w-full max-w-3xl mx-auto rounded-lg" />
