...
The resume is generated by Quarto with the following structure:
- Main content: <main class="content" id="quarto-document-content">
- Sections are nested: <section id="SECTION_ID" class="levelX">
  - level1 (H1), level2 (H2), level3 (H3)
- Headers: <h2 class="anchored">Title</h2>
- Lists: <ul><li>...</li></ul>

COMMON SECTION IDs (Japanese):
- #職務経歴書 (Main title)
- #職務要約 (Summary)
- #活かせる経験知識技術 (Skills)
  - #得意分野 (Strengths)
  ...
  - #スキル (Skills detail)
  - #資格 (Certifications)
- #プロダクト開発サービス公開 (Products)
- #ポートフォリオ (Portfolio)
- #職務経歴詳細 (Experience)

CSS TIPS:
- Use section IDs to target specific areas: `section#職務要約 { ... }`
- Use level classes for general styling: `.level2 h2 { ... }`
- To adjust lists in Skills section: `#活かせる経験知識技術 ul { ... }`
"""
